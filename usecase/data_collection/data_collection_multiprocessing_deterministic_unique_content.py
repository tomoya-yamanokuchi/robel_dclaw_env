...
class Demo_task_space:
    def run(self, config):
        ...
        task_space_position_init = np.array(
            [
                [0.14, 0.19, 0.19], # 指右上寄せ
                [0.14, 0.05, 0.05], # 指右上寄せ
                [0.19, 0.14, 0.19], # 指右上寄せ
                [0.05, 0.14, 0.05], # 指右上寄せ
                [0.19, 0.19, 0.14], # 指右上寄せ
                [0.05, 0.05, 0.14], # 指右上寄せ
            ]
        )
