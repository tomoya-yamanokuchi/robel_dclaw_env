...
# from robel_dclaw_env.domain.environment.multiprocessing.EnvironmentConstantSetting_with_InitState import EnvironmentConstantSetting_with_InitState
...
def rollout(constant_setting, queue_input, queue_result):
    ...
    for batch_index, ctrl_task_diff in enumerate(chunked_ctrl_task_diff):
        ...
        env.reset(init_state)                    # (2) resetによってテクスチャをランダム化
