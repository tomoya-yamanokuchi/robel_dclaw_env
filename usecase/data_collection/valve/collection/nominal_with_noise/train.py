...
if __name__ == "__main__":
    ...
    def main(config: DictConfig):
        ...
        # nominal_with_noise2 = demo.add_random_noise_to_nominal(nominal_ctrl, num_sample, colored_noise_exponent, planning_horizon, init_std = 0.15, sampling_bound_width = 0.02)
