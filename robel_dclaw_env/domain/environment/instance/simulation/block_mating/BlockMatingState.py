...
class BlockMatingState:
    ...
    def __assert_step__(self):
        ...
        self.assert_type_shape_dim_STEP(self.object_position, dim=7)
        self.assert_type_shape_dim_STEP(self.object_velocity, dim=6)
    ...
    def __assert_sequence__(self):
        ...
        self.assert_type_shape_dim_SEQUENCE(self.object_position, dim=7)
        self.assert_type_shape_dim_SEQUENCE(self.object_velocity, dim=6)
