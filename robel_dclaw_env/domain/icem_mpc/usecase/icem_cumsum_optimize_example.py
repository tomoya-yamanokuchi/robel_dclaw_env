...
from icem_mpc.iCEM_CumulativeSum_MPC import iCEM_CumulativeSum_MPC
...
icem = iCEM_CumulativeSum_MPC(
    ...
    lower_bound_cumulative_sum = -1.0,
    upper_bound_cumulative_sum =  1.0,
    alpha                      = 0.1,
    init_std                   = 0.4,
    verbose                    = True,
