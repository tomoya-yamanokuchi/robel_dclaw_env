...
class ValveReturnState:
    def __init__(self,
        ...
        self.task_space_positioin  = dimension_assetion(task_space_positioin,  3)
        self.robot_velocity        = dimension_assetion(robot_velocity,        9)
        self.object_position       = dimension_assetion(object_position,       1)
        self.object_velocity       = dimension_assetion(object_velocity,       1)
